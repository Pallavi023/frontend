    ...
    <div className='p-5 '>
      <div className='overflow-x-auto'>
        <table className="w-full table-auto border-collapse border bg-gray-100">
          <thead>
            <tr>
              <th className="bg-gray-200 font-bold p-2 sm:p-4">Customer</th>
              <th className="bg-gray-200 font-bold p-2 sm:p-4">Location</th>
              <th className="bg-gray-200 font-bold p-2 sm:p-4">Order Details</th>
              <th className="bg-gray-200 font-bold p-2 sm:p-4">Order Status</th>
              <th className="bg-gray-200 font-bold p-2 sm:p-4">Date/Time</th>
